                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Screenshot_2024-09-23_at_9.02.29_PM-removebg-preview.png',
                        width: 345.0,
                        fit: BoxFit.contain,
                      ),
                    ),
                        ...
                        if (_model.tabBarCurrentIndex == 0)
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if ((_model.apiResultdqh?.succeeded ?? true)) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Please check your email for welcome message!',
                                      style: TextStyle(
                                        color: FlutterFlowTheme.of(context)
                                            .primaryText,
                                      ),
